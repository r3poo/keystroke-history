...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.infoLabel = QLabel("click start to start recording, stop to stop recording,\nclear to clear history, and save to save the history and clear the history\nhide will hide the main window and clicking the tray icon will bring it back\n")
